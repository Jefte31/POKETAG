Agatha = {
       ...
       colar = 12635, --id do colar da agatha
       hammer = 12636, --id do hammer
       pilar = 3900, --id do pilar q tem q usar o hammer
       pocao = 12637, --id da poçao pra ser usada nas estantes
       
       posLab = {x = 1557, y = 1119, z = 10}, --pos do labirinto
       posQuest = {x = 1563, y = 1103, z = 9}, --pos da quest
       
       fromPos = {x = 1525, y = 1084, z = 8}, --pos superior da area dos dark abras (caso mudem a area dos D.As mudem aki)
       toPos = {x = 1566, y = 1128, z = 8}, --pos inferior da area dos dark abras (caso mudem a area dos D.As mudem aki)
