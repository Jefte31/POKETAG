...
function init()
  ...
  CatchsLabel = healthInfoWindow:recursiveGetChildById('CatchsLabel')  --alterado
  PokesLabel = healthInfoWindow:recursiveGetChildById('PokesLabel')    --alterado
...
function hideLabels()
  PokesLabel:hide()         --alterado \/
  CatchsLabel:hide()
  local removeHeight = PokesLabel:getHeight() + PokesLabel:getMarginTop() + PokesLabel:getMarginBottom()
