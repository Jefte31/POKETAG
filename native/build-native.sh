...
[[ -f "$ROOT/native/patch-native-runtime.py" ]] || { echo "Runtime-safety patch driver not found: $ROOT/native/patch-native-runtime.py" >&2; exit 1; }
...
python3 "$ROOT/native/patch-native-runtime.py" "$WORK"
